...
const UserProfile = () => {
  ...
  const fetchProfile = useCallback(async () => {
    setIsSaving(true)
    fetchApi(process.env.REACT_APP_API_URL_APIM + "/ContactsTest")
      .then(async (response) => {
        setIsSaving(false)
  ...
  const onVerifyMobile = async () => {
    ...
    postApiAnonymous(process.env.REACT_APP_API_URL_APIM + "/Twilio", {
      to: fieldValue,
  ...
  const onVerifyCode = async () => {
    ...
    if (fieldValue !== mobileCodeSMS) {
      ...
      patchApi(process.env.REACT_APP_API_URL_APIM + "/ContactsTest/me", { mobileVerified: mobileVerifiedCRMDate })
        .then(async (response) => {
          setIsSaving(false)
          setshowVerifyMobile(false)
  ...
  const Update = async (fieldName) => {
    ...
    patchApi(process.env.REACT_APP_API_URL_APIM + "/ContactsTest/me", { [fieldName]: fieldValue })
      .then(async (response) => {
        fetchProfile()
        setIsSaving(false)
        setshowAlert(true)
